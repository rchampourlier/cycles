...
var _user$project$Main$cycleCard = function (cycle) {
	return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(cycle.index)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Main$cycleCards = function (cycles) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Main$cycleCard, cycles));
};
var _user$project$Main$initialModel = {
	cycles: {
		...
		_0: {
			index: 1,
			start: A3(_Bogdanp$elm_time$Time_Date$date, 2017, 7, 3),
			end: A3(_Bogdanp$elm_time$Time_Date$date, 2017, 8, 11)
		},
		_1: {ctor: '[]'}
	},
	mdl: _debois$elm_mdl$Material$model
};
var _user$project$Main$Cycle = F3(
	function (a, b, c) {
		return {index: a, start: b, end: c};
	});
var _user$project$Main$Model = F2(
	function (a, b) {
		return {cycles: a, mdl: b};
	});
...
var _user$project$Main$AddCycle = {ctor: 'AddCycle'};
		...
		{ctor: '[]'},
		{
			...
			_0: A3(
				...
				'link',
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('https://code.getmdl.io/1.3.0/material.teal-red.min.css'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A5(
					...
					model.mdl,
					{
						...
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$AddCycle),
							_1: {
								ctor: '::',
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Add cycle'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Main$cycleCards(model.cycles),
					_1: {
						ctor: '::',
						_0: _user$project$Main$dialog(model),
						_1: {ctor: '[]'}
					}
				}
			}
